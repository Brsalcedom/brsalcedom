...
- 📓 **[brsalcedom.github.io](https://brsalcedom.github.io/)** – Focused on **pentesting**, **security research**, bug bounty writeups, and network assessments.

- 🛠 **[blog.cervant.net](https://blog.cervant.net/)** – Dedicated to **DevOps**, **IoT**, **electronics**, and detailed guides about my **homelab**, infrastructure automation, and self-hosting.
...
- [`homelab-iac`](https://github.com/brsalcedom/homelab-iac) – Modular infrastructure as code for my homelab.  
- [`rshellz`](https://github.com/brsalcedom/rshellz) – CLI Tool | Reverse shell generator for pentesting.  
- [`dotfiles`](https://github.com/brsalcedom/dotfiles) – Dotfiles for my linux desktop configuration.  
- [`amigo-secreto`](https://github.com/brsalcedom/amigo-secreto) – Simple CLI tool for organizing Secret Santa gift exchanges.

_All projects embrace automation, modularity, reproducibility, and security-first design._
